...
<head>
    ...
    <style>
        ...
        body { font-family: Arial, sans-serif; padding: 0 20px 40px 20px; }
...
<div class="no-print" style="text-align:center;margin:20px 0;"><a href="<?php echo Url::to('/reportes_1er_trimestre/pdf?id=' . $reporte['id']); ?>"
