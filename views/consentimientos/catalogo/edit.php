            ...
            <div class="card-body">
                <form method="POST" action="<?php echo Url::to('/consentimientos/catalogo/update'); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="contenido" name="contenido" placeholder="Escriba aquí el texto completo del consentimiento informado..."><?php echo htmlspecialchars($documento['contenido'] ?? ''); ?></textarea>
