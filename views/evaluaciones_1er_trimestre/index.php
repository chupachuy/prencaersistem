<?php
$title = "Evaluaciones 1er Trimestre";
...
<div class="page-header">
    <div class="d-flex align-items-center gap-3">
        <h1 class="page-title mb-0">Evaluaciones 1er Trimestre</h1>
    </div>
    <div class="page-header-actions">
        <a href="<?php echo Url::to('/evaluaciones_1er_trimestre/create'); ?>" class="btn btn-apple btn-apple-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?php echo Url::to('/evaluaciones_1er_trimestre/show?id=' . $ev['id']); ?>" class="action-btn action-btn-view" title="Ver">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="<?php echo Url::to('/evaluaciones_1er_trimestre/edit?id=' . $ev['id']); ?>" class="action-btn action-btn-edit" title="Editar">
                                            <i class="fa-solid fa-edit"></i>
                                        </a>
                                        <a href="<?php echo Url::to('/evaluaciones_1er_trimestre/pdf?id=' . $ev['id']); ?>" class="action-btn action-btn-view" target="_blank" title="Descargar PDF">
