...
<form action="<?php echo Url::to('/evaluaciones_1er_trimestre/store'); ?>" method="POST" id="formEvaluacion" enctype="multipart/form-data">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <i class="fa-solid fa-user-doctor me-2"></i> Referencia Médica
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="medico_solicitante_id" class="form-select">
                        ...
                        <?php foreach ($medicos as $m): ?>
                            <option value="<?php echo $m['id']; ?>" <?php echo Auth::id() == $m['id'] ? 'selected' : ''; ?>>
    ...
    <?php endif; ?>
     ...
     <!-- 2. Historial Clínico (Antecedentes) -->
    <div class="card mb-4">
        <div class="card-header">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" class="form-control" id="num_embarazos" name="num_embarazos" min="0" value="<?php echo htmlspecialchars($historial['num_embarazos'] ?? ''); ?>">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="num_cesareas" class="form-label">C - Cesáreas</label>
                    <input type="number" class="form-control" id="num_cesareas" name="num_cesareas" min="0" value="<?php echo htmlspecialchars($historial['num_cesareas'] ?? ''); ?>">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="num_abortos" class="form-label">A - Abortos</label>
                    <input type="number" class="form-control" id="num_abortos" name="num_abortos" min="0" value="<?php echo htmlspecialchars($historial['num_abortos'] ?? ''); ?>">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="num_ectopicos" class="form-label">E - Ectópicos</label>
                    <input type="number" class="form-control" id="num_ectopicos" name="num_ectopicos" min="0" value="<?php echo htmlspecialchars($historial['num_ectopicos'] ?? ''); ?>">
                </div>
            </div>
            <hr class="mt-0 mb-3">
            <h6 class="text-muted mb-3">Antecedentes Médicos</h6>
            <div class="row">
