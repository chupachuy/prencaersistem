<?php
$title = "Dashboard - Superadministrador";
...
<div class="page-header">
    ...
    <p class="page-subtitle">Panel de control del Superadministrador</p>
</div>
...
<div class="row">
    <div class="col-md-4 mb-4">
        <div class="stats-card" style="cursor: pointer; transition: all 0.2s;" onclick="window.location.href='<?php echo Url::to('/usuarios'); ?>'">
            ...
            <h3 class="stats-number">Usuarios</h3>
            <p class="stats-label">Gestión de usuarios del sistema</p>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="stats-card" style="cursor: pointer; transition: all 0.2s;" onclick="window.location.href='<?php echo Url::to('/asignaciones'); ?>'">
            ...
            <p class="stats-label">Ver asignaciones registradas</p>
        </div>
    </div>
</div>
